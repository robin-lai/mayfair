...
#    sleep 600
    ...
    python ./rank/prod_v2/predict_tfr_mtl_v2.py --model_name=mtl_seq_esmm_v2 --ds=20250120-20250126 --pred_ds=20250129 --proc=1 --sample_num=1
elif [ $1 = "pred_d_pdb" ]; then
    python -m pdb ./rank/prod_v2/predict_tfr_mtl_v2.py --model_name=mtl_seq_esmm_v2 --ds=20250120-20250126 --pred_ds=20250129 --proc=1 --sample_num=1
elif [ $1 = "pred" ]; then
