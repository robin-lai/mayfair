...
# nohup python -u swing_multi_process.py --pre_ds=20241228,20241229,20241230,20241231,20250101,20250102,20250103,20250104,20250105 --beta=0.7 --ubeta=0.5 --alph=1.0 --p=10
