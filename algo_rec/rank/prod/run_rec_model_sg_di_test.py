...
model_name = 'prod_ctr_seq_off_din_v0_test'
job_name ='laidehe-rec-job'
ds='20241102'
pre_ds='20241101'
instance_count=1
code_dir_s3 = 's3://warehouse-algo/rec/test_model/%s/code/' % model_name
model_dir_s3 = 's3://warehouse-algo/rec/test_model/%s/ds=%s/' % (model_name, ds)
model_dir_s3_pre = 's3://warehouse-algo/rec/test_model/%s/ds=%s/' % (model_name, pre_ds)
