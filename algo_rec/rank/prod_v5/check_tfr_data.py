...
feature_describe_pred.update({"highLevelSeqListGoods": v1.FixedLenFeature(20, tf.string, default_value=[""] * 20),
...
def main(args):
    ...
    s3_file = 's3://warehouse-algo/rec/cn_rec_detail_sample_v30_savana_in_tfr_row_n300_sample_select/ds=%s/%s' % (
    args.ds, args.file)
