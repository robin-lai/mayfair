...
#    sleep 600
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250303 --pre_ds=20250302 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250304 --pre_ds=20250303 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250305 --pre_ds=20250304 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250306 --pre_ds=20250305 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250308 --pre_ds=20250307 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250309 --pre_ds=20250308 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
#    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=3 --warm_start_from=NEWEST --train_ds=20250310-20250323 --pre_ds=20250309 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
    python run_rec_model_sg_di.py  --model_name=mtl_seq_esmm_v4 --instance_count=2 --warm_start_from=NEWEST --train_ds=20250324 --pre_ds=20250310-20250323 --eval_ds=20250120eval --sample=cn_rec_detail_sample_v30_savana_in_tfr_row_n300
