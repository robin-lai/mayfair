...
def build_feature_columns():
    ...
    numric_cols_emb = [mt_i2i_main_score,mt_i2i_long_score,mt_i2i_short_score]
    ...
    id_col_emb = [cate2_fc_emb, cate3_fc_emb, cate4_fc_emb, cate_fc_emb,
                  ...
                  m_cate_fc_emb, m_goods_id_fc_emb,sales_price_emb,
                  mt_hot_emb, mt_i2i_main_emb,mt_i2i_long_emb,mt_i2i_short_emb,mt_hot_i2leaf_emb, mt_emb]
