...
class DIN_MASK_ESMM(tf.estimator.Estimator):
    def __init__(self,
        ...
        def _model_fn_esmm(features, labels, mode, params):
            ...
            id_col_emb = params["feature_columns"]["id_col_emb"]
            id_col_emb_input = tf.feature_column.input_layer(features, id_col_emb)
            input_layer = [numric_cols_emb_input, cate_cols_emb_input, id_col_emb_input]
