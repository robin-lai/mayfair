...
def attention_layer_v2(seq_ids, tid_ids, main_id, id_type, shape):
    with tf.variable_scope("attention_" + id_type):
        ...
        main_ids_hash = tf.string_to_hash_bucket_fast(main_id, shape[0])
        ...
        main_id_emb = tf.nn.embedding_lookup(embeddings, main_ids_hash)
        merge_emb = main_id_emb * tid_emb
