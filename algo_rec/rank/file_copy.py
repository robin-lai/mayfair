...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog='file_copy')
    parser.add_argument('--range', type=str, default='20250120,20250121,20250122,20250123')
    parser.add_argument('--from_dir', type=str, default='s3://warehouse-algo/rec/cn_rec_detail_sample_v30_savana_in_tfr/ds=%s/')
    parser.add_argument('--to_dir', type=str, default='s3://warehouse-algo/rec/cn_rec_detail_sample_v30_savana_in_tfr/ds=20250120-20250126/')
