...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog='file_copy')
    parser.add_argument('--range', type=str, default='20250120,20250121,20250122,20250123,20250124,20250125,20250126,20250127,20250128')
    parser.add_argument('--from_dir', type=str, default='s3://warehouse-algo/rec/cn_rec_detail_sample_v30_savana_in_tfr_row_n300/ds=%s/')
    parser.add_argument('--to_dir', type=str, default='s3://warehouse-algo/rec/cn_rec_detail_sample_v30_savana_in_tfr_row_n300/ds=20250120-20250128/')
