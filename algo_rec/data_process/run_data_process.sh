...
#  20250120,20250121,20250122,20250130,20250131
    python gen_tfrecored_multi_process_with_gen_mt.py --range=20250201,20250202,20250203,20250204,20250205 --stat_flag=True
    ...
    python gen_tfrecored_multi_process_with_gen_mt.py --range=20250127,20250128,20250129 --stat_flag=True
