...
def build_tfrecord(path_pt_list, path_tfr_local_list, path_tfr_s3_list,proc_id,stat_file,stat_flag, args
                   ):
...
def main(args):
    ...
    proc_list = [multiprocessing.Process(target=build_tfrecord, args=(
        fll[0], fll[1], fll[2],proc_id, args.stat_file,args.stat_flag, args
        # itm_shm.name, itm_shm_size, i2i_shm.name, i2i_shm_size, u2cart_wish_shm.name, u2cart_wish_shm_size,
